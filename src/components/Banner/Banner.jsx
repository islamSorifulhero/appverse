        ...
        <div className="hero bg-base-200 pt-4">
            <div className="hero-content text-center">
                <div className="w-11/12 mx-auto">
                    ...
                    <div className='mb-6'>
                        <button className="font-bold mr-3 btn"><img src={playStore} alt="" />Google Play</button>
                        <button className="btn ml-3"><img src={appStore} alt="" />App Store</button>
                    </div>
                    <img className='mx-auto w-160' src={hero} alt="" />

                    <div className="w-full text-white py-10 bg-gradient-to-r from-[#632EE3] to-[#9F62F2]">
                        <h1 className='mb-6 text-4xl font-bold'>Trusted by Millions, Built for You</h1>
